...
Nombre_benchmark = 'flat300_28'#"myciel3"#"myciel4"#'2-Fullins_3'#"jean"#"anna"#"DSJC250-5"#"DSJC500-5"#"le450_15c"#"le450_25c"#
...
def BusquedaLocal_CUDA(nuevo_individuos, probabilidades,Aristmono,MatrizAdjacencia, H,numNodos,tam_pobla,rng_states):
    ...
    individuoCuda = cuda.local.array(shape= (numColores,NODOS), dtype= int32)
    probabilidadCuda = cuda.local.array(shape = numColores, dtype = float32)
    MatrizAdjCuda = cuda.local.array(shape=(NODOS,NODOS), dtype=int32)
